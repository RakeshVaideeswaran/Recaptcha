package com.example.rakesh.recaptcha;
...
public class MainActivity extends AppCompatActivity {
    ...
    String SITE_SECRET_KEY = "6LePbzsUAAAAAMQ04OGZGtzl1IoITHSnZt_7VxBK";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        Button recaptcha = (Button) findViewById(R.id.recaptcha_button);
    ...
    {
        SafetyNet.getClient(this).verifyWithRecaptcha("6LePbzsUAAAAADJppR5nnVsJ5D_dHl17dw7SxPF0")
